...
if ( ! function_exists( 'm_fox_setup' ) ) :
	...
	function m_fox_setup() {
		...
		add_theme_support( 'custom-background', apply_filters( 'm_fox_custom_background_args', array(
 ...
 */
function m_fox_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'm_fox_content_width', 640 );
}
add_action( 'after_setup_theme', 'm_fox_content_width', 0 );
...
function m_fox_scripts() {
	...
	wp_enqueue_script( 'm-fox-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'm-fox-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
